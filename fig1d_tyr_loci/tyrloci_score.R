...
myfile <- "200919_tyrloci_score.xlsx"
...
scores[,10] <- NULL # column with number dysmorphic
...
# export ------------------------------------------------------------------
setwd(dirname(rstudioapi::getSourceEditorContext()$path)) # wherever the script is
ggsave('f0_tyrloci_score.pdf', plot=scorestack, width=65, height=57.9, unit='mm', useDingbats=FALSE) # f0paper