...
myfile <- "200919_tyrloci_fish.xlsx"
...
# pool clutches -----------------------------------------------------------
notok_n <- aggregate(fish$totalunviable,
...
fishpool <- merge(notok_n, tots_n, by='condition')
...
ggsave('f0_tyrloci_unviable.pdf', plot=poolbar, width=65, height=20, unit='mm', useDingbats=FALSE)